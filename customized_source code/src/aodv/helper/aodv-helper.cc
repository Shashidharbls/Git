  ...
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      ...
      Ptr<Ipv6RoutingProtocol> proto6 = ipv6->GetRoutingProtocol ();
      NS_ASSERT_MSG (proto6, "Ipv6 routing not installed on node");
      Ptr<aodv::RoutingProtocol> aodv6 = DynamicCast<aodv::RoutingProtocol> (proto6);
      ...
      Ptr<Ipv6ListRouting> list6 = DynamicCast<Ipv6ListRouting> (proto6);
      if (list6)
        {
          int16_t priority;
