...
uint32_t
RreqHeader6::GetSerializedSize6 () const
{
  return 23;
}

void
RreqHeader6::Serialize6 (Buffer::Iterator i) const
{
  i.WriteU8 (m_flags6);
  i.WriteU8 (m_reserved6);
  i.WriteU8 (m_hopCount6);
  i.WriteHtonU32 (m_requestID6);
  WriteTo (i, m_dst6);
  i.WriteHtonU32 (m_dstSeqNo6);
  WriteTo (i, m_origin6);
  i.WriteHtonU32 (m_originSeqNo6);
}
